...
$activity= '<p style="color:green;">'.$name.' was turned off <small>'.$date_time.'</small><b>-'.$energy.'</b></p>';

 
mysqli_query($con, "UPDATE `appliances` SET `status`='1'  WHERE appliance_id='$appliance_id' "); 
